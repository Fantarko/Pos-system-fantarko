...
/** สรุปยอดขาย สินค้าขายดี และข้อมูลสำหรับรายงานของผู้ดูแล */
export default function ReportsPage() {
  ...
  /** โหลดข้อมูลคำสั่งซื้อและคำนวณตัวชี้วัดสำหรับรายงาน */
  async function fetchData() {
    ...
    if (items) {
      ...
      const productMap: Record<
        string,
        { total_sold: number; revenue: number }
      > = {};
      items.forEach((i) => {
        const name =
          (i.products as unknown as { name?: string } | null)?.name ?? "ไม่ทราบ";
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-slate-400">รายงานยอดขายย้อนหลัง 30 วัน</p>
          </div>
        ...
        <div className="mb-10 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="group rounded-3xl border border-slate-800 bg-slate-900 p-6 transition hover:-translate-y-1 hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/10">
            <div className="mb-5 flex items-center justify-between">
              <div className="rounded-2xl bg-blue-500/10 p-4 text-3xl">🧾</div>
            ...
            <h2 className="mt-2 text-3xl font-bold">{stats.totalOrders}</h2>
          </div>
          ...
          <div className="group rounded-3xl border border-slate-800 bg-slate-900 p-6 transition hover:-translate-y-1 hover:border-amber-500 hover:shadow-xl hover:shadow-amber-500/10">
            <div className="mb-5 flex items-center justify-between">
              <div className="rounded-2xl bg-amber-500/10 p-4 text-3xl">📈</div>
            ...
            <p className="text-sm text-slate-400">ยอดเฉลี่ยต่อออเดอร์</p>
          ...
          <div className="group rounded-3xl border border-slate-800 bg-slate-900 p-6 transition hover:-translate-y-1 hover:border-purple-500 hover:shadow-xl hover:shadow-purple-500/10">
            ...
            <p className="text-sm text-slate-400">จำนวนสินค้าที่ขาย</p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-6 mb-8">
          ...
          <div className="xl:col-span-2 rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-xl">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold text-white">🏆 สินค้าขายดี</h2>

                <p className="mt-1 text-sm text-slate-400">Top 5 Products</p>
              </div>
