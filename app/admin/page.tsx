...
export default function AdminPage() {
  ...
  /** ตรวจสอบ session และโหลดโปรไฟล์ผู้ดูแลสำหรับส่วนหัวของหน้า */
  ...
  /** ดึงและรวมสถิติคำสั่งซื้อ รายได้ และสินค้าในระบบ */
  async function fetchStats() {
    ...
    const [
      ...
      supabase
        .from("orders")
        .select("id, total, created_at, payment_methods(name)")
    ...
    const todayRevenue =
      todayOrdersData?.reduce((sum, o) => sum + o.total, 0) ?? 0;
  ...
  useEffect(() => {
    checkAuth();
    // การเปลี่ยนสถานะเกิดหลังการรอผลจากฐานข้อมูลภายใน fetchStats
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          <div className="mb-5">
            ...
            <p className="text-sm text-slate-400">ภาพรวมข้อมูลทั้งหมดของร้าน</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
            <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6 hover:border-blue-500/40 transition">
              ...
              <p className="text-slate-400 text-sm">ออเดอร์ทั้งหมด</p>
            ...
            <div className="rounded-2xl border border-emerald-900 bg-emerald-950/30 p-6 hover:border-emerald-500/40 transition">
              <div className="text-3xl mb-3">💵</div>
              <p className="text-emerald-300 text-sm">รายได้รวม</p>
            ...
            <div className="rounded-2xl border border-orange-900 bg-orange-950/20 p-6 hover:border-orange-500/40 transition">
              <div className="text-3xl mb-3">📦</div>
              <p className="text-orange-300 text-sm">สินค้าทั้งหมด</p>
              <h3 className="mt-3 text-4xl font-bold text-white">
                {stats.totalProducts}
              </h3>
            </div>
            ...
            <div className="rounded-2xl border border-violet-900 bg-violet-950/20 p-6 hover:border-violet-500/40 transition">
              <div className="text-3xl mb-3">👥</div>
              <p className="text-violet-300 text-sm">ลูกค้าทั้งหมด</p>
              <h3 className="mt-3 text-4xl font-bold text-white">
